This file defines the natural number type from
Peano arithmetic, including addition, multiplication, and subtraction.

It also replaces several Prelude operations on lists that use integers as
arguments with versions that use the Nat type.
